...
def build_system_prompt(context: str | None = None, intent: str = "casual", scenario: str | None = None) -> str:
    """
    ...
    if scenario:
        ...
        parts.append("\n\n*Ground your responses in this scenario. When the user asks about their future, actions, or trajectory, refer to this scenario naturally.*")
