...
def classify_intent(query: str) -> str:
    ...
    # Check in order of specificity (advice before factual to catch "should I" with data words)
...
INTENT_TO_MODE = {
    "factual": "mix",        # entities + relationships + raw chunks
    "pattern": "global",     # relationship-centric (high-level patterns)
    "advice": "hybrid",      # local + global combined
    "reflection": "hybrid",  # local + global combined
    "emotional": None,       # no KG fetch — just SOUL.md personality
    "casual": None,          # no KG fetch
}
